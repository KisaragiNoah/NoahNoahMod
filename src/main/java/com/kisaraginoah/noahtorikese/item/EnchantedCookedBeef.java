...
public class EnchantedCookedBeef extends Item {
    public EnchantedCookedBeef() {
        super(new Properties().food(new FoodProperties.Builder().nutrition(16).saturationModifier(1.0F).effect(() -> new MobEffectInstance(MobEffects.HEALTH_BOOST, 9600, 3), 1.0F).build()).stacksTo(64));
    }
